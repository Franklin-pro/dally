import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///home/franklin/Desktop/dally%20project/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/franklin/Desktop/dally%20project/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///home/franklin/Desktop/dally%20project/node_modules/devalue/index.js';
import destr from 'file:///home/franklin/Desktop/dally%20project/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///home/franklin/Desktop/dally%20project/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/franklin/Desktop/dally%20project/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/franklin/Desktop/dally%20project/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///home/franklin/Desktop/dally%20project/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/franklin/Desktop/dally%20project/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/franklin/Desktop/dally%20project/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///home/franklin/Desktop/dally%20project/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/franklin/Desktop/dally%20project/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/franklin/Desktop/dally%20project/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/franklin/Desktop/dally%20project/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/franklin/Desktop/dally%20project/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/franklin/Desktop/dally%20project/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/franklin/Desktop/dally%20project/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///home/franklin/Desktop/dally%20project/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/franklin/Desktop/dally%20project/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///home/franklin/Desktop/dally%20project/node_modules/vue/index.mjs';
import BaseStyle from 'file:///home/franklin/Desktop/dally%20project/node_modules/@primevue/core/base/style/index.mjs';
import { Theme } from 'file:///home/franklin/Desktop/dally%20project/node_modules/@primeuix/styled/index.mjs';
import { basename } from 'file:///home/franklin/Desktop/dally%20project/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/franklin/Desktop/dally%20project/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file:///home/franklin/Desktop/dally%20project/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///home/franklin/Desktop/dally%20project/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/franklin/Desktop/dally%20project/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/franklin/Desktop/dally%20project/node_modules/@unhead/shared/dist/index.mjs';
...
const _SIr8cNZj02 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/home/franklin/Desktop/dally project";
...
const _dhlfFr1v3g = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const serverAssets = [{"baseName":"server","dir":"/home/franklin/Desktop/dally project/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/franklin/Desktop/dally project"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/franklin/Desktop/dally project/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/franklin/Desktop/dally project/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/franklin/Desktop/dally project/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/franklin/Desktop/dally project/.data/kv"}));
...
const _myQS9GysIx = defineNitroPlugin(async (nitroApp) => {
...
const _603uTm = defineCachedEventHandler(async (event) => {
...
const _lazy_sNbkVs = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_sNbkVs, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _603uTm, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_sNbkVs, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///home/franklin/Desktop/dally%20project/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/franklin/Desktop/dally%20project/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
